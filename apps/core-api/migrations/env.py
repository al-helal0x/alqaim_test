"""Alembic env.py — Async (يعمل مع asyncpg). يقرأ رابط قاعدة البيانات من
نفس Settings المستخدَمة في التطبيق (platform_core/config.py) بدل تكراره.
"""
import asyncio
...
# استيراد كل Models حتى تكون معروفة لـ Base.metadata عند autogenerate
